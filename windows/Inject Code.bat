...
# Code from OneDrive Complete uninstaller batch process for Windows 10, then heavily worn down to the basic Administrator requirements.
NET SESSION >nul 2>&1
...
cd..
type motd-adblock >> %WinDir%\System32\drivers\etc\hosts
echo Done!
pause
